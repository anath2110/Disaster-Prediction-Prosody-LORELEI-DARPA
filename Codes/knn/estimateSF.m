function outputDir=estimateSF(outputPath,trainpath,testpath,trainname,testname,featurefile,newOroldAnno)
...
flag=0;% gets incremented every time the following code encounters a pitchCache file
 ...
 for i=1:nfiles      
     if(strcmp(basenames(i),'pitchCache')==0)
         ...
         estimatespertestrowBinary=rawEstimates.votePerTest(12:17);%estimates per patch of test audio
         ...
         estimatesBinary = rawEstimates.stancePrediction(12:17);
