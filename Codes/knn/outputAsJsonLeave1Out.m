...
function outputAsJsonLeave1Out(pathToDirWithEstimates,outfilename)
...
writeResultsAsJson(nfiles, typeList,reliefList,urgencyList,...
    basenamesAppended,normEstimates, outfiledir);
 end
function writeResultsAsJson(nfiles, typeList,reliefList,urgencyList,...
  ...
  for f = 1:nfiles  
    ...
    for ix = 1:ntypes
      ...
      ansObj.Justification_ID =  basenamesAppended(f,:);
      %%%issue frame%%%
