function [refmatfile,confusionMatrix]= createRefModelLeaveOneOut(refmatfile,outputDir,trainpath,trainname,featurefile,newOroldAnno,delSkip,train)
...
for i=1:size(trainpath,1)
   ...
   [examined, typesPresent] = getLabelsLeaveOneOut(trainSetDir,newOroldAnno,train); 
