function [estimatesmat,neighbormat,testmatfile]=estimateSFMto1GravityLeaveOneOut(outputDir,featurefile,refmatfile,testpath,testname,confusionMatrix,test)
