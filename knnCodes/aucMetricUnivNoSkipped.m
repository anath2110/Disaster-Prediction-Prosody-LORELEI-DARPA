function aucMetricUnivNoSkipped()
% 
% testpath = 'C:\ANINDITA\Lorelei_2018\Lorelei_2018\EvaluationJuly''18\Langauge packs\TrainIL10\IL10_Set0\IL10_Set0\';
...
% pred = load('C:\ANINDITA\Lorelei_2018\Lorelei_2018\Results\reRuns\UniversalTrain_IL10_Set0\estimateSF.mat');
% %disp(estimatesStruct);
% pred = pred.normalizedEstimates;
% pred=pred(find(perFileLabels(:,19)==0),:);
% save('UnivIL10Set0', 'labels','perFileLabels','nonSkippedLabels','pred');
loadmatfiles('UnivIL10Set0.mat','UnivIL10Set1.mat');
end
